...
export default function PreWeather() {
    const {
        projectName,
        fullDescription,
        techStacks,
        ...
        <>
            ...
            <div className="py-2 mx-5 sm:mx-12 md:mx-52">
                ...
                <div>
                    ...
                    <img
                        src="https://res.cloudinary.com/dmfvcclh3/image/upload/v1755527324/Screenshot_2025-08-18_193032_iqv0rr.png"
                        alt="pre-weather-app"
                        className="w-full h-auto object-cover my-6 rounded-md "
                    />

                    <img
                        src="https://res.cloudinary.com/dmfvcclh3/image/upload/v1755527323/Screenshot_2025-08-18_193146_id1kxo.png"
                        alt="fuzion-app"
                        className="w-full h-auto object-cover my-6 rounded-md"
                    />

                    <img
                        src="https://res.cloudinary.com/dmfvcclh3/image/upload/v1755527322/Screenshot_2025-08-18_193324_ctymca.png"
                        alt="fuzion-app"
                        className="w-full h-auto object-cover my-6 rounded-md"
                    />
                </div>
